...
//   These are local variables used to help gather the list of url that we want to request
        ...
        console.log(address)
        fetch('"https://www.zillow.com/menlo-park-ca/?searchQueryState=%257B%2522pagination%2522%253A%257B%257D%252C%2522mapBounds%2522%253A%257B%2522west%2522%253A-122.36375114160158%252C%2522east%2522%253A-121.99433585839846%252C%2522south%2522%253A37.366067654869966%252C%2522north%2522%253A37.55193003681727%257D%252C%2522regionSelection%2522%253A%255B%257B%2522regionId%2522%253A39748%252C%2522regionType%2522%253A6%257D%255D%252C%2522isMapVisible%2522%253Atrue%252C%2522filterState%2522%253A%257B%2522sort%2522%253A%257B%2522value%2522%253A%2522globalrelevanceex%2522%257D%252C%2522ah%2522%253A%257B%2522value%2522%253Atrue%257D%257D%252C%2522isListVisible%2522%253Atrue%252C&wants=\{%22cat1%22:\[%22mapResults%22\]\}&requestId=2', {
        headers: {
            'Accept': '*/*',
    ...
    var cleanedListing = Listings.map((house,indx)=>{
        ...
        if(house.hdpData){
            var newListing = {
                ...
                statusType:house.statusType,
                statusText:house.statusText,
                link: "www.zillow.com/"+house.detailUrlhouse.detailUrl,
