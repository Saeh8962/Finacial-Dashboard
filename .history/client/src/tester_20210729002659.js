...
function getZillowData(town_r,city_r,state_r){
    ...
    fetch('https://www.zillow.com/'+address+'/', {
            ...
            var RentUrl ='https://www.zillow.com/search/GetSearchPageState.htm?searchQueryState=%7B%22pagination%22%3A%7B%7D%2C%22mapBounds%22%3A%7B%22west%22%3A'+params.mapBounds.west+'%2C%22east%22%3A'+params.mapBounds.east+'%2C%22south%22%3A'+params.mapBounds.south+'%2C%22north%22%3A'+params.mapBounds.north+'%7D%2C%22regionSelection%22%3A%5B%7B%22regionId%22%3A'+params.regionSelection.regionId+'%2C%22regionType%22%3A'+params.regionSelection.regionType+'%7D%5D%2C%22isMapVisible%22%3Atrue%2C%22isForRent%22%3A%7B%22value%22%3Atrue%7D%2C%22isForSaleByAgent%22%3A%7B%22value%22%3Afalse%7D%2C%22isForSaleByOwner%22%3A%7B%22value%22%3Afalse%7D%2C%22isNewConstruction%22%3A%7B%22value%22%3Afalse%7D%2C%22isComingSoon%22%3A%7B%22value%22%3Afalse%7D%2C%22isAuction%22%3A%7B%22value%22%3Afalse%7D%2C%22isForSaleForeclosure%22%3A%7B%22value%22%3Afalse%7D%2C%22isPreMarketForeclosure%22%3A%7B%22value%22%3Afalse%7D%2C%22isPreMarketPreForeclosure%22%3A%7B%22value%22%3Afalse%7D%7D%2C%22isListVisible%22%3Atrue%7D&wants={%22cat1%22:[%22listResults%22,%22mapResults%22]}'
            ...
            console.log('responce',ListingInfo[0])
            ...
            convertToExcel(address)
            }))
        }))
}


function convertToExcel(address){
    var fileid=Math.floor(Math.random() * 50)
    var fileName =address+'_report'+fileid+'.xlsx'
