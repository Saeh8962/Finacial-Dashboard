...
export default function GetStockQoutes(stocks: any[],callback: any){
      const [eodData,seteodData]=React.useState<EodData[]>()
     
        if(eodData){
          geteodData(stocks,function(data:any){
            var newData = eodData.push(data);
            seteodData({
              eodData: newData,
            })
          })
      ...
      function geteodData(stocks: any[],callback: { (data: EodData): void}){
          ...
          return (request.get({
            ...
            if (err) {
              ...
              // data is successfully parsed as a JSON object:
                Object.values(data).forEach(item =>{Object.values(item).forEach(i=>Data.push(i))})
