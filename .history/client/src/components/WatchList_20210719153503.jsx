    ...
    saveNewStockTrade= (event) => {
        ...
        if(result.type==="trade"){
            user_watchlist.forEach(symbol => {
                ...
                console.log(Alerts.uniqueSymbols.includes({symbol:symbol.symbol}))
                if((Alerts!=="" && Alerts!== "No Alerts found" &&Alerts!==undefined)&&Alerts.uniqueSymbols.includes({symbol:symbol.symbol})){
