        ...
        if(result.type==="trade"){
            user_watchlist.forEach(symbol => {
                ...
                if(alerts.uniqueSymbols.includes(symbol.Symbol)){
                  ...
                  switch(alerts.Identifier){
                    case 'Price':
                        switch(alerts.movement){
                            case 'Above':{
                              if(symbol.currentPrice > alerts.valuechange){
                                alert("Your Price Alert watching for "+symbol.Symbol+" to go above: "+alerts.valuechange+" has been triggered")
                            ...
                            case 'Below':{
                              if(symbol.currentPrice < alerts.valuechange){
                                alert("Your Price Alert watching for "+symbol.Symbol+" to go below: "+alerts.valuechange+" has been triggered")
                                return ("Alert has been triggered");
                              }
                    ...
                    case 'Percent':
                        switch(alertsmovment){
                            case 'Up':{
                              if(symbol.CurrentPercentChange > alerts.valuechange){
                                alert("Your Percentage Alert watching for "+symbol.Symbol+" to be moving up: "+alerts.valuechange+"% has been triggered")
                                return ("Alert has been triggered");
                              }
                            ...
                            case 'Down':{
                              if(symbol.CurrentPercentChange < alerts.valuechange){
                                alert("Your Percentage Alert watching for "+symbol.Symbol+" to be moving down: "+alerts.valuechange+"% has been triggered")
