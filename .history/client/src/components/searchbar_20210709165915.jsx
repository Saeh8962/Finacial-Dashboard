...
import UserAlerts from "./panels/PerformancePanel";
...
handleChange(event) {
  ...
  render(){
      ...
      <PanelBar> 
        ...
        <PanelBarItem expanded={false} title="Alerts">
          <PanelBarItem expanded={false} title="Your Alerts">
            <UsersAlerts email={this.props.email}/>
          </PanelBarItem>
              ...
              <div className="FormField">
                <div className="row">
                  ...
                  <div className= "m-3">
                    <DropDownList 
                    label = "Identifier"
                    data={this.handleIdentifierSelection}
                    textfield="Price or % Change"
                    />
                  </div>
                  <div className= "m-3">
    ...
    //       </form> */}
    //       <PanelBarItem expanded={false} title="Your Alerts" />
    //         {/* show the invidual stocks that the user has alerts for */}
    //             {/* when the user clicks on the idividual sockk item  have a dropdown show up 
    //             where the user can choose to turn off individual alerts or remove the alert*/}
    //       {/* </PanelBarItem> */}
    //       <PanelBarItem expanded={false} title="Add an Alert" >
    //         <form className= "FormFields">
    //             <div className="FormField">
    //                 <div>Choose a stock symbol:</div>
    //                 <ComboBox data={this.stocks.map(stocks=>stocks.symbol)} allowCustom={true}/>
    ...
    //                   <div/>
    //                 </div>
    //               <Button  className= "ButtonNoRight" onClick={this.addUserStock}>Save Alert</Button>
    //               <input  className= "FormField_Input" onChange={this.handleChange} placeholder= "Symbol" type="text" name="stock" />
    //             </div>
    //         </form>
    //             {/* First have the user choose a stock from their watch list of search for a new stock  */}
    //             {/* have radio buttons for the user to turn on and off for different track categories*/}
    //         </PanelBarItem>
    //     </PanelBarItem>
    // </PanelBar>
    )
