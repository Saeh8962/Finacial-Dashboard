...
export default withRouter( class WatchList extends React.Component {
    ...
    CommandCell = (props) => (
      ...
      componentWillMount(){
        ...
        // console.log(data);
        this.setState({eodData:this.getEodData("AAPL")},()=>console.log(this.state.eodData))
      ...
      getEodData(symbol){
        ...
        request(fullUrl, { json: true }, (err, res, body) => {
          ...
          var eod={
            ...
            high: body.data.high,
            low: body.data.low,
            close: body.data.close,
            volume: body.data.volume,
            adj_high: body.data.adj_high,
            adj_low: body.data.adj_low,
            adj_close: body.data.adj_close,
            adj_open: body.data.adj_open,
            adj_volume: body.data.adj_volume,
            split_factor: body.data.split_factor,
