        ...
        if(result.type==="trade"){
            user_watchlist.forEach(symbol => {
                ...
                if(tradePrice.length !==0){
                    ...
                    symbol["changeV"]= +(symbol.currentPrice-symbol.latest_trading_day).toFixed(2);
                    symbol.["changeP"]= +((symbol["changeV"]/symbol["latest_trading_day"])*100).toFixed(2);
                    
                }
                if((Alerts!=="" && Alerts!== "No Alerts found" &&Alerts!==undefined)&&Alerts.uniqueSymbols.includes(symbol.Symbol)){
