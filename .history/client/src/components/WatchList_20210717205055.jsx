...
function ChangeCurPriceColor(props){
  const curValue = props.dataItem[props.field || ""].toFixed(2);
...
function ChangeCurChangeColor(props){
  const value = props.dataItem[props.field || ""]>0? "+"+props.dataItem[props.field].toFixed(2):props.dataItem[props.field || ""].toFixed(2);
