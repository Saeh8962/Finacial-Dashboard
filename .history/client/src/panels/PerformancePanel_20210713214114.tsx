...
if(history){
  console.log(history)
  var history_OpenDat = history.map((data:History,idx:number)=>(console.log(data)))

  var history_OpenData = history.map((data:History,idx:number)=>({data:data[1],date:convertHistoryDate(data.date)}))
