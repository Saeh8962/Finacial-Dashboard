...
export default function Useralerts(props:any) {
    ...
    // console.log(toggle);
        return(
        <svg id = "toggle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33 33">
            <switch>
                <g>
                <path className="circ path"  d="M6.2,6.2L6.2,6.2 c-5.7,5.7-5.7,14.8,0,20.5l0,0c5.7,5.7,14.8,5.7,20.5,0l0,0c5.7-5.7,5.7-14.8,0-20.5l0,0C21.1,0.6,11.9,0.6,6.2,6.2z"/>
