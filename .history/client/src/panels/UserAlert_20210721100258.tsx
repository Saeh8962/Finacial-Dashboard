...
export default function Useralerts(props:any) {
    function toggleButton(props:any){
        ...
        // const OnButton = <button> <img src={require(SVG)} alt="ToggleButton"/> </button>
        return(
            <html>
                <head>
                ...
                <i className="indicator">
                    <svg version="1.1" id="toggle" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"  viewBox="0 0 33 33" style="enable-background:new 0 0 33 33;" xml:space="preserve">
