    ...
    <PanelBar>
      ...
      <Button  className= "ButtonNoRight" onClick={handleClick}>Choose </Button>
        <div className="row">
          ...
          <div className= "m-3">
            <NumericTextBox defaultValue={0} step={.5} onChange={(e)=>setState({change:e.value})} /><span><Button  className= "ButtonNoRight" onClick={handleAlert}>Save Alert </Button></span>
          </div>
        </div>
      </div>
