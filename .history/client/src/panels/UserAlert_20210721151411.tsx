...
export default function Useralerts(props:any) {
    function toggleButton(props:any){
        ...
        const activeValue = 'true';
         ...
         if(activeValue ==="true"){
             var isChecked =checked:isJsxAttributes
            // $('.btn span').css({
            //     'float': 'left',
            //     'color': '#fff',
            //     'font-family': 'Arial',
    ...
    // console.log(toggle);
    if(activeValue==="true"){
        const toggleBar= <input type="checkbox" id={props.id} checked/> 
    }
    // if(activeValue==="false"){
    //     var toggleBar=<input type="checkbox" id={props.id}/> 
    // }
        return(
            <div>
            ...
            <switch>
                <g>
                <path className="tick path" style= {x} d="M6.2,6.2L6.2,6.2 c-5.7,5.7-5.7,14.8,0,20.5l0,0c5.7,5.7,14.8,5.7,20.5,0l0,0c5.7-5.7,5.7-14.8,0-20.5l0,0C21.1,0.6,11.9,0.6,6.2,6.2z"/>
                <polyline className="cross path" style={y} points=" 11.4,11.4 21.6,21.6 "/>
