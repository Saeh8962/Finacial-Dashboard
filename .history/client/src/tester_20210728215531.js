...
//   These are local variables used to help gather the list of url that we want to request
    ...
    //   fetch(url) 
        fetch('https://www.zillow.com/search/GetSearchPageState.htm?searchQueryState=%7B%22pagination%22%3A%7B%7D%2C%22mapBounds%22%3A%7B%22west%22%3A'+params.mapBounds.west+'%2C%22east%22%3A'+params.mapBounds.east+'%2C%22south%22%3A'+params.mapBounds.south+'%2C%22north%22%3A'+params.mapBounds.north+'%7D%2C%22regionSelection%22%3A%5B%7B%22regionId%22%3A'+params.regionSelection[0].regionId+'%2C%22regionType%22%3A'+params.regionSelection[0].regionType+'%7D%5D%2C%22isMapVisible%22%3Atrue%2C%22filterState%22%3A%7B%22sort%22%3A%7B%22value%22%3A%22globalrelevanceex%22%7D%2C%22ah%22%3A%7B%22value%22%3Atrue%7D%7D%2C%22isListVisible%22%3Atrue%2C%22mapZoom%22%3A11%7D&wants=\{%22cat1%22:\[%22mapResults%22\]\}', {
...
function hi(){
    ...
    //    body.text().then(result=>console.log(result))
        // response.text().then(function(result1){
...
//             'Connection': 'keep-alive',
//         }
//     }).then(result => console.log('Result2',result.headers))
